...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post beers_url, params: { beer: { alcohol: @beer.alcohol, blg: @beer.blg, hop: @beer.hop, ibu: @beer.ibu, malts: @beer.malts, name: @beer.name, style: @beer.style, yeast: @beer.yeast } }
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { alcohol: @beer.alcohol, blg: @beer.blg, hop: @beer.hop, ibu: @beer.ibu, malts: @beer.malts, name: @beer.name, style: @beer.style, yeast: @beer.yeast } }
